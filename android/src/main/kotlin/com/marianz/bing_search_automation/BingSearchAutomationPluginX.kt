...
class BingSearchAutomationPluginX: FlutterPlugin, MethodCallHandler {
  ...
  override fun onMethodCall(call: MethodCall, result: MethodResult) {
    if (call.method == "getPlatformVersion") {
      ...
      if (query != null) {
        SearchAccessibilityServiceX.searchQueue.clear()
        SearchAccessibilityServiceX.searchQueue.add(query.toString())
      ...
      if (list != null) {
        SearchAccessibilityServiceX.searchQueue.clear()
        SearchAccessibilityServiceX.searchQueue.addAll(list)
      ...
      result.success(SearchAccessibilityServiceX.getCurrentQuery())
  ...
  private fun isServiceEnabled(context: Context): Boolean {
    ...
    return enabledServices.contains(context.packageName + "/" + SearchAccessibilityServiceX::class.java.name)
  }
  ...
  private fun launchBingApp(context: Context) {
    try {
      ...
      if (launchIntent != null) {
        ...
        SearchAccessibilityServiceX.setLaunchedFromApp(true)
